...
@section('content')
    {{-- Start Dashboard Content --}}
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">All Notes</h1>

                    <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">My Notes</h6>
                        </div>
                        <div class="card-body">
                            @if(session('success'))
                                    ...
                                    <tbody>
                                        @foreach($notes as $note)
                                            <tr>
                                                ...
                                                <td>{{ $note->note }}</td>
                                                <td>
                                                    <a href="{{ route('notes.edit', $note->id) }}" class="btn btn-sm btn-primary"><i class="fas fa-edit"></i> Edit</a>
